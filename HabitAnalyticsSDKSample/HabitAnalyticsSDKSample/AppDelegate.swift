...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        {
            HabitAnalytics.shared.initialize(namespace: Configurations.Namespace) { (statusCode) in
        ...
        HabitAnalytics.shared.initialize(namespace: Configurations.Namespace, authInfo: loadedUserAuth) { (statusCode) in
            debugPrint("Habit Analytics initialization code: " + String(statusCode) + " : " + HabitStatusCodes.getDescription(code: statusCode))
        }
